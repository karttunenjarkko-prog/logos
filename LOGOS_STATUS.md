...
- [ ] **Implement SPARRI_CHALLENGE_SCHEMA:** Refactor `logosEngine.js` to use a strict schema that forces the detection of one assumption and one sharp question[cite: 2].
- [ ] **Sycophancy Filter:** Update system prompts to forbid agreeable openers like "Great idea" or "I understand"[cite: 2].
